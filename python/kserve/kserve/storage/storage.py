...
class Storage(object):
    ...
    def get_S3_config():
        ...
        # NOTE: If endpoint_url provided is legacy ("https://s3.amazonaws.com") and region is not global, set to virtual addressing style
        ...
        if endpoint_url == "https://s3.amazonaws.com" and region:
            c = c.merge(Config(s3={"addressing_style": "virtual"}))
